	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord903 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord901 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,-0.5 );
				#ifdef _ISDEAD_ON
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord903 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord901 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,-0.5 );
				#ifdef _ISDEAD_ON
				float2 staticSwitch902 = texCoord901;
				#else
				float2 staticSwitch902 = texCoord903;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord903 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord901 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,-0.5 );
				#ifdef _ISDEAD_ON
				float2 staticSwitch902 = texCoord901;
				#else
				float2 staticSwitch902 = texCoord903;
...
/*ASEBEGIN
Version=18901
826;150;1601;1338;-3873.952;-347.7222;1.3;True;True
...
Node;AmplifyShaderEditor.StaticSwitch;897;3982.062,1313.741;Float;False;Property;_Wind;Wind;4;0;Create;True;0;0;0;False;0;False;1;1;1;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C676A72D45A92F1400353724F3C6CC8BA7894E1E