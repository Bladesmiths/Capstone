	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				#endif
				float2 texCoord937 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 rotator745 = mul( texCoord746 - float2( 0.25,0.25 ) , float2x2( cos745 , -sin745 , sin745 , cos745 )) + float2( 0.25,0.25 );
				#ifdef _WIGGLE_ON
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float staticSwitch921 = 0.0;
				#endif
				float2 texCoord937 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord937 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				float staticSwitch921 = 0.0;
				#endif
				float2 texCoord937 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18901
826;150;1601;1338;-3953.062;-554.62;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;955;1764.049,1665.584;Float;False;Global;WindTurbulenceFloat;WindTurbulenceFloat;4;0;Create;False;0;0;0;False;0;False;0.5;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;959;2282.204,1876.771;Float;False;Global;WindStrenghtFloat;WindStrenghtFloat;3;0;Create;False;0;0;0;False;0;False;0.5;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;921;3681.644,508.4387;Inherit;False;Property;_Snow;Snow;3;0;Create;True;0;0;0;False;0;False;1;1;1;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E409CE8AB3A21E42FAC50795AB845B1387AB1443