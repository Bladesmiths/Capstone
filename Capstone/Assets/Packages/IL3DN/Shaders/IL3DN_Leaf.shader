...
Shader "IL3DN/Leaf"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			inline float4 TriplanarSampling967( sampler2D topTexMap, float3 worldPos, float3 worldNormal, float falloff, float2 tiling, float3 normalScale, float3 index )
			{
						...
						)
			{
				...
				float4 triplanar967 = TriplanarSampling967( _ColorVariationTexture, ase_worldPos, normalWS, 1.0, ( float2( 1,1 ) / _ColorVariationScale ), 1.0, 0 );
				float3 hsvTorgb968 = RGBToHSV( _Color.rgb );
				float4 normalizeResult970 = normalize( ( triplanar967 * hsvTorgb968.x ) );
				float3 hsvTorgb972 = HSVToRGB( float3(normalizeResult970.x,hsvTorgb968.y,hsvTorgb968.z) );
				float2 texCoord746 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord944 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_927_0 = float3( (WindDirection).xz ,  0.0 );
				float2 panner931 = ( 1.0 * _Time.y * ( temp_output_927_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xy);
				...
				float2 rotator945 = mul( texCoord944 - float2( 0.5,0.5 ) , float2x2( cos945 , -sin945 , sin945 , cos945 )) + float2( 0.5,0.5 );
				#ifdef _WIGGLE_ON
				...
				float4 blendOpSrc973 = float4( hsvTorgb972 , 0.0 );
				float4 blendOpDest973 = ( _Color * tex2DNode97 );
				float4 lerpBlendMode973 = lerp(blendOpDest973,2.0f*blendOpDest973*blendOpSrc973 + blendOpDest973*blendOpDest973*(1.0f - 2.0f*blendOpSrc973),_ColorVariationNoise);
				...
				surfaceDescription.Albedo = saturate( ( staticSwitch917 + ( saturate( lerpBlendMode973 )) ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 triplanar967 = TriplanarSampling967( _ColorVariationTexture, ase_worldPos, ase_worldNormal, 1.0, ( float2( 1,1 ) / _ColorVariationScale ), 1.0, 0 );
				float3 hsvTorgb968 = RGBToHSV( _Color.rgb );
				float4 normalizeResult970 = normalize( ( triplanar967 * hsvTorgb968.x ) );
				float3 hsvTorgb972 = HSVToRGB( float3(normalizeResult970.x,hsvTorgb968.y,hsvTorgb968.z) );
				float2 texCoord746 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord944 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_927_0 = float3( (WindDirection).xz ,  0.0 );
				float2 panner931 = ( 1.0 * _Time.y * ( temp_output_927_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xy);
				float4 worldNoise905 = ( tex2D( NoiseTextureFloat, ( ( panner931 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
				float cos945 = cos( ( tex2D( NoiseTextureFloat, worldNoise905.rg ) * LeavesWiggleFloat * _WiggleStrenght ).r );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord746 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord944 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_927_0 = float3( (WindDirection).xz ,  0.0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 panner931 = ( 1.0 * _Time.y * ( temp_output_927_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xy);
				float4 worldNoise905 = ( tex2D( NoiseTextureFloat, ( ( panner931 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord746 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord944 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_927_0 = float3( (WindDirection).xz ,  0.0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 panner931 = ( 1.0 * _Time.y * ( temp_output_927_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xy);
				float4 worldNoise905 = ( tex2D( NoiseTextureFloat, ( ( panner931 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
		...
		Pass
		{
						...
						)
			{
				...
				float4 normalizeResult970 = normalize( ( triplanar967 * hsvTorgb968.x ) );
				float3 hsvTorgb972 = HSVToRGB( float3(normalizeResult970.x,hsvTorgb968.y,hsvTorgb968.z) );
				float2 texCoord746 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord944 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_927_0 = float3( (WindDirection).xz ,  0.0 );
				float2 panner931 = ( 1.0 * _Time.y * ( temp_output_927_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xy);
				float4 worldNoise905 = ( tex2D( NoiseTextureFloat, ( ( panner931 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
				float cos945 = cos( ( tex2D( NoiseTextureFloat, worldNoise905.rg ) * LeavesWiggleFloat * _WiggleStrenght ).r );
...
/*ASEBEGIN
Version=18901
826;150;1601;1338;-3079.132;167.0412;1.630352;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;932;1747.459,1662.68;Float;False;Global;WindTurbulenceFloat;WindTurbulenceFloat;4;0;Create;False;0;0;0;False;0;False;0.5;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;934;2275.242,1865.899;Float;False;Global;WindStrenghtFloat;WindStrenghtFloat;3;0;Create;False;0;0;0;False;0;False;0.5;0.8;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;963;668.8922,-457.9824;Inherit;False;2135.505;586.8222;Use world noise to add color variation to the leaves.;9;972;971;970;969;968;967;966;965;964;Color Variation;0.9623866,0,1,1;0;0
...
Node;AmplifyShaderEditor.Vector2Node;964;837.9543,-340.3711;Inherit;False;Constant;_Vector1;Vector 0;13;0;Create;True;0;0;0;False;0;False;1,1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;965;720.0341,-141.2684;Inherit;False;Property;_ColorVariationScale;Color Variation Scale;11;0;Create;True;0;0;0;False;0;False;50;0;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;966;1094.922,-337.4199;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RGBToHSVNode;968;1456.285,-155.9485;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;969;1795.682,-183.0747;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.NormalizeNode;970;1964.693,-181.7771;Inherit;False;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.HSVToRGBNode;972;2180.902,-127.9663;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;971;2128.065,35.38476;Inherit;False;Property;_ColorVariationNoise;Color Variation Noise;10;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BlendOpsNode;973;4278.865,-138.974;Inherit;False;SoftLight;True;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;919;3770.889,1559.604;Inherit;False;Constant;_Float1;Float 0;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;918;4518.328,520.7137;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;921;4156.484,1631.802;Inherit;False;Property;_Snow2;Snow;3;0;Create;True;0;0;0;False;0;False;1;1;1;True;_SNOW_ON;Toggle;2;Key0;Key1;Reference;917;False;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;962;4699.541,1184.264;Inherit;False;Constant;_Float2;Float 2;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;923;4663.683,1044.019;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;897;3701.915,1311.666;Float;False;Property;_Wind;Wind;5;0;Create;True;0;0;0;False;0;False;1;1;1;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;910;3971.231,1403.038;Float;False;Property;_AlphaCutoff;Alpha Cutoff;1;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;922;4379.285,1264.192;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;959;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-7;255;False;-1;255;True;-8;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;3;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;952;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;961;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-28;False;False;False;True;True;True;True;True;0;True;-44;False;False;False;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;958;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;False;True;True;True;True;True;0;True;-44;False;False;False;False;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;954;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;960;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;951;4941.115,1043.757;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;5;IL3DN/Leaf;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;42;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;1;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;4;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;0;Receives SSR;0;Receive SSR Transparent;0;Motion Vectors;0;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;956;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;953;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;957;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;955;4761.688,1046.534;Float;False;False;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;3;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;False;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
...
WireConnection;968;0;292;0
WireConnection;945;0;944;0
WireConnection;945;2;943;0
WireConnection;967;3;966;0
WireConnection;969;0;967;0
WireConnection;969;1;968;1
...
WireConnection;972;1;968;2
WireConnection;972;2;968;3
...
ASEEND*/
//CHKSM=F060FBC271A6D3435B0FDE42470E1D0F0228CD19