...
namespace Bladesmiths.Capstone
{
    ...
    /// <summary>
    /// Container for player sword fields likely to be changed for balancing
    /// </summary>
    public class SwordData : SerializedScriptableObject
    {
        #region Fields
        [SerializeField]
        [Tooltip("The damage of the sword")]
        ...
        [SerializeField]
        [Tooltip("The multiplier to apply to the player's speed when moving")]
        private float playerMovementMultiplier = 1.0f;

        [SerializeField]
        [Tooltip("How much damage must be done to the player before they are knocked back")]
        private float knockboackThreshold;

        [SerializeField]
        [Tooltip("Length of time betwen releasing block and parry becoming active")]
        private float parryDelay = 0.1f;

        [SerializeField]
        [Tooltip("Length of time parry is active")]
        private float parryLength = 0.1f;

        [SerializeField]
        [Tooltip("Length of time after parry ceases to be active that the player cannot act")]
