	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				inputMesh.tangentOS = float4( ( inputMesh.tangentOS.xyz * inputMesh.normalOS * 0.0 ) , 0.0 );
						...
						)
			{
				...
				#ifdef _SNOW_ON
				float staticSwitch88_g7 = ( normalWS.y * SnowTerrainFloat );
				#else
				...
				surfaceDescription.Albedo = MixDiffuse28_g7.xyz;
