	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_382_0 = ( 1.0 - _FoamScale );
				float simplePerlin2D244 = snoise( ( panner253 * 1 )*temp_output_382_0 );
				float2 panner292 = ( 0.1 * _Time.y * float2( -1,0 ) + temp_output_252_0);
				float simplePerlin2D290 = snoise( ( panner292 * 2 )*temp_output_382_0 );
				...
				float2 texCoord241 = packedInput.ase_texcoord6.xy * temp_output_347_0 + temp_cast_1;
				...
				float2 texCoord364 = packedInput.ase_texcoord6.xy * temp_output_347_0 + temp_cast_2;
				...
				float fresnelNdotV340 = dot( normalWS, V );
				float fresnelNode340 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV340, _Smoothness ) );
				
				float fresnelNdotV341 = dot( normalWS, V );
				float fresnelNode341 = ( 0.2 + 1.0 * pow( 1.0 - fresnelNdotV341, _Transparency ) );
				
				surfaceDescription.Albedo = saturate( ( saturate( ( ( _FoamColor * foamWater218 ) + ( _FoamColor * foamEdge280 ) ) ) + ( _TopColor * topWater237 ) + lerpResult13 ) ).rgb;
				surfaceDescription.Normal = BlendNormal( unpack238 , unpack362 );
				...
				surfaceDescription.Smoothness = saturate( fresnelNode340 );
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = saturate( fresnelNode341 );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float mulTime242 = _TimeParameters.x * _Speed;
				float2 temp_cast_1 = (mulTime242).xx;
				float2 texCoord241 = packedInput.ase_texcoord2.xy * temp_output_347_0 + temp_cast_1;
				float3 unpack238 = UnpackNormalScale( tex2D( _Normal, texCoord241 ), _NormalStrenght );
				unpack238.z = lerp( 1, unpack238.z, saturate(_NormalStrenght) );
				float2 temp_cast_2 = (( 1.0 - mulTime242 )).xx;
				float2 texCoord364 = packedInput.ase_texcoord2.xy * temp_output_347_0 + temp_cast_2;
				float3 unpack362 = UnpackNormalScale( tex2D( _Normal, texCoord364 ), _NormalStrenght );
				unpack362.z = lerp( 1, unpack362.z, saturate(_NormalStrenght) );
				...
				float fresnelNdotV340 = dot( ase_worldNormal, ase_worldViewDir );
				float fresnelNode340 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV340, _Smoothness ) );
		...
		Pass
		{
					...
					)
			{
				...
				float fresnelNdotV341 = dot( ase_worldNormal, V );
				float fresnelNode341 = ( 0.2 + 1.0 * pow( 1.0 - fresnelNdotV341, _Transparency ) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_output_347_0 = ( float2( 100,100 ) * _Size );
				float mulTime242 = _TimeParameters.x * _Speed;
				float2 temp_cast_0 = (mulTime242).xx;
				float2 texCoord241 = packedInput.ase_texcoord3.xy * temp_output_347_0 + temp_cast_0;
				float3 unpack238 = UnpackNormalScale( tex2D( _Normal, texCoord241 ), _NormalStrenght );
				unpack238.z = lerp( 1, unpack238.z, saturate(_NormalStrenght) );
				float2 temp_cast_1 = (( 1.0 - mulTime242 )).xx;
				float2 texCoord364 = packedInput.ase_texcoord3.xy * temp_output_347_0 + temp_cast_1;
				float3 unpack362 = UnpackNormalScale( tex2D( _Normal, texCoord364 ), _NormalStrenght );
				unpack362.z = lerp( 1, unpack362.z, saturate(_NormalStrenght) );
		...
		Pass
		{
				...
				)
			{
				...
				float fresnelNdotV340 = dot( ase_worldNormal, V );
				float fresnelNode340 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV340, _Smoothness ) );
		...
		Pass
		{
						...
						)
			{
				...
				float mulTime242 = _TimeParameters.x * _Speed;
				float2 temp_cast_1 = (mulTime242).xx;
				float2 texCoord241 = packedInput.ase_texcoord8.xy * temp_output_347_0 + temp_cast_1;
				float3 unpack238 = UnpackNormalScale( tex2D( _Normal, texCoord241 ), _NormalStrenght );
				unpack238.z = lerp( 1, unpack238.z, saturate(_NormalStrenght) );
				float2 temp_cast_2 = (( 1.0 - mulTime242 )).xx;
				float2 texCoord364 = packedInput.ase_texcoord8.xy * temp_output_347_0 + temp_cast_2;
				float3 unpack362 = UnpackNormalScale( tex2D( _Normal, texCoord364 ), _NormalStrenght );
				unpack362.z = lerp( 1, unpack362.z, saturate(_NormalStrenght) );
...
/*ASEBEGIN
Version=18901
826;150;1601;1338;1912.945;1768.802;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;381;-3094.038,-2667.981;Inherit;False;Property;_FoamScale;Foam Scale;13;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScreenDepthNode;1;-1310.408,-2596.476;Inherit;False;0;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;382;-2706.038,-2660.981;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;383;-1885.726,-1898.421;Inherit;False;Property;_EdgeReach;Edge Reach;11;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;386;-1954.392,-1514.754;Inherit;False;Property;_FoamReach;Foam Reach;12;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;387;-1566.392,-1507.754;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;384;-1497.726,-1891.421;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;219;-1535.444,-1620.341;Inherit;False;208;edgeEffect;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;385;-1272.726,-1956.921;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;388;-1341.392,-1573.254;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;356;-1565.957,-1051.706;Inherit;False;1051.563;320.1928;Deep Water Layer;7;94;87;214;10;170;368;380;;0.7678117,1,0,1;0;0
...
Node;AmplifyShaderEditor.AbsOpNode;380;-1290.279,-961.1934;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;369;0;350;0
WireConnection;369;1;361;0
WireConnection;369;7;349;0
WireConnection;369;9;348;0
ASEEND*/
//CHKSM=287BBDC0A6A28D8CB0CB349708842555134BFCD8