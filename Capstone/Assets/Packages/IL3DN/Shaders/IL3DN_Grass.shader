	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord1074 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_1056_0 = float3( (WindDirection).xz ,  0.0 );
				...
				float2 rotator1075 = mul( texCoord1074 - float2( 0.5,0.5 ) , float2x2( cos1075 , -sin1075 , sin1075 , cos1075 )) + float2( 0.5,0.5 );
				#ifdef _WIGGLE_ON
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float staticSwitch1049 = 0.0;
				#endif
				float2 texCoord746 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord1074 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_1056_0 = float3( (WindDirection).xz ,  0.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord1074 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_1056_0 = float3( (WindDirection).xz ,  0.0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 panner1060 = ( 1.0 * _Time.y * ( temp_output_1056_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xz);
				float4 worldNoise1038 = ( tex2D( NoiseTextureFloat, ( ( panner1060 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord1074 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_1056_0 = float3( (WindDirection).xz ,  0.0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 panner1060 = ( 1.0 * _Time.y * ( temp_output_1056_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xz);
				float4 worldNoise1038 = ( tex2D( NoiseTextureFloat, ( ( panner1060 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord1074 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_output_1056_0 = float3( (WindDirection).xz ,  0.0 );
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float2 panner1060 = ( 1.0 * _Time.y * ( temp_output_1056_0 * WindSpeedFloat * 10.0 ).xy + (ase_worldPos).xz);
				float4 worldNoise1038 = ( tex2D( NoiseTextureFloat, ( ( panner1060 * WindTurbulenceFloat ) / float2( 10,10 ) ) ) * _WindStrenght * WindStrenghtFloat );
...
/*ASEBEGIN
Version=18901
826;150;1601;1338;-3406.485;-327.3902;1.664263;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;1090;4657.128,1208.595;Inherit;False;Constant;_Float1;Float 1;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;1031;3725.854,1379.861;Float;False;Property;_Wind;Wind;5;0;Create;True;0;0;0;False;0;False;1;1;1;True;_WIND_ON;Toggle;2;Key0;Key1;Create;False;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;1036;4525.946,1455.28;Float;False;Property;_AlphaCutoff;Alpha Cutoff;1;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=AAACD2F6BDE0E5FEB65AF00BFBA090D6735FBD5A