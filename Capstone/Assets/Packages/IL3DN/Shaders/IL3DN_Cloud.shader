	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				surfaceDescription.Color = ( _Color * tex2DNode9 ).rgb;
...
/*ASEBEGIN
Version=18901
826;150;1601;1338;806.9851;752.6139;1.016558;True;True
