	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput inputMesh  )
			{
				...
				#ifdef _WIND_ON
				float4 staticSwitch897 = ( float4( WindDirection , 0.0 ) * ( ( inputMesh.ase_color.a * worldNoise908 ) + ( worldNoise908 * inputMesh.ase_color.g ) ) );
				#else
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float2 texCoord906 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord905 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,-0.5 );
				#ifdef _ISDEAD_ON
				...
				surfaceDescription.Color = lerpResult901.rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord906 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord905 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,-0.5 );
				#ifdef _ISDEAD_ON
				float2 staticSwitch903 = texCoord905;
				#else
				float2 staticSwitch903 = texCoord906;
...
/*ASEBEGIN
Version=18901
823;150;1601;1338;-3829.705;-361.383;1.3;True;True
...
Node;AmplifyShaderEditor.StaticSwitch;897;3983.99,1315.858;Float;False;Property;_Wind;Wind;5;0;Create;True;0;0;0;False;0;False;1;1;1;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldToObjectTransfNode;886;3739.315,1449.748;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;929;0;901;0
WireConnection;929;2;97;4
WireConnection;929;3;907;0
WireConnection;929;6;897;0
ASEEND*/
//CHKSM=3918D0D94068B9DCB58049E54F46CEBCE1A84FF1